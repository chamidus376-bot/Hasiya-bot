...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK:https://chat.whatsapp.com/H7wAa2RWqqAJlKrRMz48sH
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: './ʜᴀꜱɪʏᴀbot.jpg',
    NEWSLETTER_JID: '120363421363503978@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94762825783,
    CHANNEL_LINK:https://whatsapp.com/channel/0029VbBnXS9KWEKooDd1vR3l
};
...
*▫️Hasiya-MD Main Website 🌐*
> https://Hasiya-md.pages.dev
`;
        ...
        },
        {
            ...
            nativeFlowInfo: {
                ...
                paramsJson: JSON.stringify({
                    ...
                    sections: [
                        {
                            title: `Hasiya 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃`,
                            highlight_label: '',
                            rows: [
                                {
                                    title: 'MENU 📌',
                                    description: '𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 Hasiya 𝐌𝙳',
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://i.ibb.co/TDgzTB29/HasiyaMd.png" },
        caption: `Hasiya 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://i.ibb.co/TDgzTB29/HasiyaMd.png" },
        caption: `Hasiya 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐋𝙸𝚂𝚃 𝐌𝙴𝙽𝚄\n\n${captionText}`,
    }, { quoted: msg });
    ...
    break;
                ...
                break;
		        case 'owner': {
    const ownerNumber = '+94742825783';
    const ownerName = 'ʜᴀꜱᴀᴅᴜ ᴛʜᴇᴡᴍɪɴɪɴᴀ';
    const organization = '*Hasiya-𝐌𝐃* WHATSAPP BOT DEVALOPER 🍬';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `*Hasiya-MD OWNER*\n\n👤 Name: ${ownerName}\n📞 Number: ${ownerNumber}\n\n> 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 Hasiya 𝐌𝙳`,
            contextInfo: {
  ...
  break;
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *Hasiya 𝐌𝙳 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
    ...
    break;
                ...
                case 'ai': {
                    ...
                    const prompt = `ඔබගේ නම Hasiya 𝐀𝐈.  
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '🤍🦋 Hasiya 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 is running',
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || 'Hasiya-MINI-main'}`);
});
